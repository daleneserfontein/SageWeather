...
const fileCrud = require('./file')


//Define paths for express config
//express expects the views directory for the handlebars pages.  if it is not present, need to set the path to pages
const htmlFilePath = path.join(__dirname, '../../pages')
const viewsPath = path.join(__dirname, '../../pages/views/file')
const partialsPath = path.join(__dirname, '../../pages/partials/file')
